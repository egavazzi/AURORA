...
%         axis([ax(1:3) 300])
        colorbar_labeled('photons/m^3/s')
        orient tall
%         print('-depsc2','-painters',fullfile(results_dir,FigDir,strcat(dDir(i1).name,'-',RunDirs{i2},'-Qtz-01.eps')))
%         print('-dpng','-painters',fullfile(results_dir,FigDir,strcat(dDir(i1).name,'-',RunDirs{i2},'-Qtz-01.png')))
...
%         print('-depsc2','-painters',fullfile(results_dir,FigDir,strcat(dDir(i1).name,'-',RunDirs{i2},'-It-01.eps')))
%         print('-dpng','-painters',fullfile(results_dir,FigDir,strcat(dDir(i1).name,'-',RunDirs{i2},'-It-01.png')))
      catch
