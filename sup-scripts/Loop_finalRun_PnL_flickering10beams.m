%% Batch-processing-script for FAB-flickering aurora
% This script is the batch-level script for running through the set
% of FAB-parameters and calculate the ionospheric electron-fluxes
% during rapidly varying precipitation.
...
%                  (m)  Hz   #           %     eV  S/H/P
par_list4PnL = {3000e3,  5,  7,      B_W(1),  3e3, 'H','PnLh-05-3000-3keV-0-10';
                3000e3,  5,  7,      B_W(1),  5e3, 'H','PnLh-05-3000-5keV-0-10';%
                3000e3,  5,  7,      B_W(1),  7e3, 'H','PnLh-05-3000-7keV-0-10';
                4000e3,  5,  7,      B_W(1),  3e3, 'H','PnLh-05-4000-3keV-0-10';%
                4000e3,  5,  7,      B_W(1),  5e3, 'H','PnLh-05-4000-5keV-0-10';
                4000e3,  5,  7,      B_W(1),  7e3, 'H','PnLh-05-4000-7keV-0-10';%
                3000e3,  7,  7,      B_W(1),  3e3, 'H','PnLh-07-3000-3keV-0-10';
                3000e3,  7,  7,      B_W(1),  5e3, 'H','PnLh-07-3000-5keV-0-10';%
                3000e3,  7,  7,      B_W(1),  7e3, 'H','PnLh-07-3000-7keV-0-10';
                4000e3,  7,  7,      B_W(1),  3e3, 'H','PnLh-07-4000-3keV-0-10';%
                4000e3,  7,  7,      B_W(1),  5e3, 'H','PnLh-07-4000-5keV-0-10';
                4000e3,  7,  7,      B_W(1),  7e3, 'H','PnLh-07-4000-7keV-0-10';%
                3000e3, 10,  7,      B_W(1),  3e3, 'H','PnLh-10-3000-3keV-0-10';
                3000e3, 10,  7,      B_W(1),  5e3, 'H','PnLh-10-3000-5keV-0-10';%
                3000e3, 10,  7,      B_W(1),  7e3, 'H','PnLh-10-3000-7keV-0-10';%
                4000e3, 10,  7,      B_W(1),  3e3, 'H','PnLh-10-4000-3keV-0-10';%
                4000e3, 10,  7,      B_W(1),  5e3, 'H','PnLh-10-4000-5keV-0-10';%
                4000e3, 10,  7,      B_W(1),  7e3, 'H','PnLh-10-4000-7keV-0-10';%
                2000e3,  5,  7,      B_W(1),  3e3, 'H','PnLh-05-2000-3keV-0-10';%
                2000e3,  7,  7,      B_W(1),  3e3, 'H','PnLh-07-2000-3keV-0-10';%
                2000e3, 10,  7,      B_W(1),  3e3, 'H','PnLh-10-2000-3keV-0-10';%
                3000e3,  5,  7,      B_W(1),  3e3, 'S','PnLs-05-3000-3keV-0-10';%
                3000e3, 10,  7,      B_W(1),  3e3, 'S','PnLs-10-3000-3keV-0-10';%
                3000e3,  5,  7,  [1 1]*B_W(1), 3e3, 'H','PnLh-05-3000-3keV-0-30';
                3000e3,  7,  7,  [1 1]*B_W(1), 3e3, 'H','PnLh-07-3000-3keV-0-30';
                3000e3, 10,  7,  [1 1]*B_W(1), 3e3, 'H','PnLh-10-3000-3keV-0-30';
                3000e3,  5,  7,[1 1 1]*B_W(1), 3e3, 'H','PnLh-05-3000-3keV-0-60';
                3000e3,  7,  7,[1 1 1]*B_W(1), 3e3, 'H','PnLh-07-3000-3keV-0-60';
                3000e3, 10,  7,[1 1 1]*B_W(1), 3e3, 'H','PnLh-10-3000-3keV-0-60';
               };
...
i2do1 = [1:2:size(par_list4PnL,1)];
i2do2 = [2:2:size(par_list4PnL,1)];
i2do3 = [size(par_list4PnL,1):-1:1];
...
%%
for i_pars = i2do2, %Run_section(1)
