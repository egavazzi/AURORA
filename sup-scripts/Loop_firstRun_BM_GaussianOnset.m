...
%                 (m)       Hz     #           %           eV   char
par_list4G_10 = {30e3,   0.0001,   6,      (1),  [3e3 100], 'G_fa_st10-3000-3keV-0-10';
                 30e3,   0.0001,   6,      (1),  [5e3 100], 'G_fa_st10-3000-5keV-0-10';
                 30e3,   0.0001,   6,      (1),  [7e3 100], 'G_fa_st10-3000-7keV-0-10';
                 30e3,   0.0001,   6,      (1),  [1e3 100], 'G_fa_st10-3000-1keV-0-10';
                 30e3,   0.0001,   6,      (1:5),[1e3 100], 'G_fa_st10-3000-1keV-0-90';
                 30e3,   0.0001,   6,      (1:5),[3e3 100], 'G_fa_st10-3000-3keV-0-90';
                 30e3,   0.0001,   6,      (1:5),[5e3 100], 'G_fa_st10-3000-5keV-0-90';
                 30e3,   0.0001,   6,      (1:5),[7e3 100], 'G_fa_st10-3000-7keV-0-90'};

%% 12-stream
par_list4G_12 = {30e3,   0.0001,   6,        (1),[1e3 100], 'G_fa_st12-3000-1keV-0-10'
                 30e3,   0.0001,   6,      (1:6),[1e3 100], 'G_fa_st12-3000-1keV-0-90'};
%% 18-stream
par_list4G_18 = {30e3,   0.0001,   6,      (1:9),[1e3 100], 'G_fa_st18-3000-1keV-0-90'};
%% 18-stream-b
par_list4G_18b = {30e3,  0.0001,   6,        (1),[1e3 100], 'G_fa_st19-3000-1keV-0-10'
                  30e3,  0.0001,   6,      (1:9),[1e3 100], 'G_fa_st19-3000-1keV-0-90'};
%% 20-stream
par_list4G_20 = {30e3,   0.0001,   6,     (1:10),[1e3 100], 'G_fa_st20-3000-1keV-0-90'};
...
for i_pars = 1:size(par_list4G_10,1) %Run_section(1)
  ...
  curr_BW  = B_W(par_list4G_10{i_pars,4}) %
  ...
  for i1 = 1:n_loop,
    ...
    [Ie_ztE] = Ie_Mstream_tz_Bm_2_aurora_faster(h_atm,mag_ze,B,E(1:iEmax),mu_lims,mu_scatterings,...
                                                t_run,...
...
for i_pars = 1:size(par_list4G_12,1) %Run_section(1)
  ...
  curr_BW  = B_W(par_list4G_12{i_pars,4}) % B_W;
...
for i_pars = 1:size(par_list4G_18,1) %Run_section(1)
  ...
  curr_BW  = B_W(par_list4G_18{i_pars,4}) % B_W;
...
for i_pars = 1:size(par_list4G_18b,1) %Run_section(1)
  ...
  curr_BW  = B_W(par_list4G_18b{i_pars,4}) % B_W;
...
for i_pars = 1:size(par_list4G_20,1) %Run_section(1)
  ...
  curr_BW  = B_W(par_list4G_20{i_pars,4}) % B_W;
