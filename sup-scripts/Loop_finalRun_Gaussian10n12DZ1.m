%% Gaussian onset into atmosphere with constant dz

%% Setup
stepE = 1;
setup4etrptd10streamsDZ1
...
%% 10-stream
theta_lims2do = fliplr([0 10 30 60 80 90 100 120 150 170 180])
...
par_list4G_fa = {30e3, 0.0001,   6,        B_W(1),  [1e3 100], 'G_DZ1_st10-3000-1keV-0-10'
                 30e3, 0.0001,   6,      B_W(1:6),  [1e3 100], 'G_DZ1_st10-3000-1keV-0-90'};
...
par_list4G_fa = {30e3, 0.0001,   6,        B_W(1),  [1e3 100], 'G_DZ1_st12-3000-1keV-0-10'
                 30e3, 0.0001,   6,      B_W(1:6),  [1e3 100], 'G_DZ1_st12-3000-1keV-0-90'};
