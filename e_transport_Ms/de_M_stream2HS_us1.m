function [Ie_z] = de_M_stream2HS_us1(h_atm,mu,I_top_of_mu,QC_mu,A,B_b2b,Mi2im1,Mi2ip1,lowerBvals)
  ...
  for i3 = 1:size(B_b2b,2),
    if i2 ~= i3
      if mu(i2) < 0 % down-ward fluxes,
        ...
        if i2 == i3 + 1
          s_Bb2b = s_Bb2b + [0;-C_Mirror*Mi2im1{i2}];
        elseif i2 == i3 - 1
          s_Bb2b = s_Bb2b + [0;-C_Mirror*Mi2ip1{i2}];
        end
      else % up-ward fluxes
        ...
        if i2 == i3 + 1
          s_Bb2b = s_Bb2b + [-C_Mirror*Mi2im1{i2};0];
        elseif i2 == i3 - 1
          s_Bb2b = s_Bb2b + [-C_Mirror*Mi2ip1{i2};0];
        end
      end
      %[iBb2b,jBb2b,sBb2b] = find(Bb2b);
      %sBb2b = sparse(iBb2b,jBb2b,sBb2b);
      %sBb2b([1,end],:) = 0;
      s_Bb2b([1 end]) = 0;
      ...
      if mu(i2) < 0 % down-ward fluxes,
        ...
        %Ac = Ad;
        % sAc = sparse(iAd,jAd,sAd);
        sAc = sparse(iAd,jAd,sAd+[0;C_Mirror*Mi2ip1{i2}+C_Mirror*Mi2im1{i2}]);
        % sAc = sparse(iAd,jAd,sAd+[0;0*0*Mi2ip1{i2}+0*0*Mi2im1{i2}]);
        %Bb2b = diag(-(B_b2b(:,i2,i3)/2 + B_b2b([2:end,end],i2,i3)/2));
        s_Bb2b = -(B_b2b(:,i2,i3)/2 + B_b2b([2:end,end],i2,i3)/2);
     else % up-ward fluxes
        ...
        % Ac = Au;
        % sAc = sparse(iAu,jAu,sAu);
        sAc = sparse(iAu,jAu,sAu+[C_Mirror*Mi2ip1{i2}+C_Mirror*Mi2im1{i2};0]);
        %Bb2b = diag(-(B_b2b([1,1:end-1],i2,i3)/2 + B_b2b(:,i2,i3)/2));% diag(-B_b2b(:,i2,i3));
        s_Bb2b = -(B_b2b([1,1:end-1],i2,i3)/2 + B_b2b(:,i2,i3)/2);
      end
      %[iBb2b,jBb2b,sBb2b] = find(Bb2b);
