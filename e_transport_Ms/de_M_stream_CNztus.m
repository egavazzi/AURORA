function [Ie_zt] = de_M_stream_CNztus(h_atm,t_in,mu,I_top_of_t,I0,v,QC_mu,A,B_b2b,Dz,lowerBvals)
% de_M_stream_CNztus - multistream Crank-Nicholson electron transport
...
D2Zd = 1/2*( diag(1./(diff(h_atm)).^2,-1) + ...
