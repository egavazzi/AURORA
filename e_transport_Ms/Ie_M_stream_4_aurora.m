function [Ie_zE,mu_pars_out] = Ie_M_stream_4_aurora(h,mag_ze,E,mu_lims,mu_pars,Ie_primary,p_e_q,ne,Te,varargin)
...
%   end
  ...
  [Ie_ziE] = de_M_stream_us(h/abs(cos(mag_ze)),c_o_mu,...
                            Ie_p,...
                            deg_Ie(:,iE)+(p_e_Q(:)),...
                            A,elsc_b2b, ...
                            0);
