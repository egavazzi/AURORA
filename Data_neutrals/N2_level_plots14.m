...
try
  ...
  %% Label the bands
text(6.6183,.75018,'Vegard-Kaplan','rotation',90,...
     'fontsize',ftsz,'fontweight',fntw)
text(6.65,6.6835,'1st pos.',...
     'fontsize',ftsz,'fontweight',fntw)
text(5.6651,9.1414,'2nd positive',...
     'fontsize',ftsz,'fontweight',fntw)
text(2.0911,16.0101,'Meinel',...
     'fontsize',ftsz,'fontweight',fntw)
text(3.0,17.569,'1st negative',...
     'fontsize',ftsz,'fontweight',fntw)
text(0.4710,.9411,'Lyman-Birge-Hopfield','rotation',90,...
     'fontsize',ftsz,'fontweight',fntw)
text(1.7920,3.2414,'Birge-Hopfield','rotation',90,...
     'fontsize',ftsz,'fontweight',fntw)
