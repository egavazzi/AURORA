function Ie = Ie_flickeringGauss_flux2(t,E,I0,E0,dE,Ie_LET,E_LET,w,z0,Emax,Iflicker,Ef,dEf,mu,mu0)
% IE_FLICKERINGGAUSS_FLUX2 - Gaussian with LET harmonically modulated
% electron spectra. IE_FLICKERINGGAUSS_FLUX2 gives electron spectra
...
% 
% Calling:
%   Ie = Ie_flickeringGauss_flux2(t,E,I0,E0,dE,Ie_LET,E_LET,w,z0,Emax,Iflick,Ef,dEf,mu,mu0)
% Input:
...
if w > 0
  ...
  Ie = I0*exp(-(E-E0).^2/dE^2) + ...
       Iflicker*exp(-(E-Ef).^2/dEf^2)*sin(pi/2).^2.*(t_shifted>0);
end
  [~,iE] = min(abs(E-E_LET));
